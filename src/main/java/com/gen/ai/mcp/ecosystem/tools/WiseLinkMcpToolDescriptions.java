...
/**
 * 与主工程 {@code WiseLinkTool} / {@code WiseLinkToolSecurityInterceptor} 拼接结果逐字对齐的工具描述常量，
...
public final class WiseLinkMcpToolDescriptions {
    ...
    /** 与主工程 {@code WiseLinkExportService#exportShoppingReport} 上 {@code @WiseLinkTool#description()} 全文一致。 */
